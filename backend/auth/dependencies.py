...
def get_current_user_flexible(
    ...
    """Accept the normal bearer header or a query token for protected <img>.

    HTML image tags cannot attach an Authorization header. Query-token access
    is limited to image routes and uses the same opaque, expiring session token.
    """
