...
class LoginWindow(ttk.Frame):
    def __init__(self, root: tk.Tk, on_success):
        ...
        ttk.Label(self, text="📦 OTI-WAREHOUSE SWAG",
                  font=("Segoe UI", 15, "bold")).grid(row=0, column=0,
                                                      columnspan=2, pady=(0, 2))
        ttk.Label(self, text="Admin — approvals & inventory",
...
class MainWindow(ttk.Frame):
    def __init__(self, root: tk.Tk, api: ApiClient, user: dict, on_logout):
        ...
        bar.pack(fill="x")
        tk.Label(bar, text="📦 OTI-WAREHOUSE SWAG — ADMIN", bg=theme.BAR,
...
class App:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Oti-Warehouse Swag — Admin")
